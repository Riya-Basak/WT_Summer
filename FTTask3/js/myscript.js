...
function checkname()
{
    ...
    if(!isNaN(namevalue))
    {
        ...
        document.getElementById("nameerror").innerHTML="Name can not be numeric";
        return false;
    
    }
    else if(isNaN(namevalue) && namevalue.length<4)
    {
    ...
    {
        document.getElementById("nameerror").innerHTML="fname is correct";
        return true;
    }
}
function checklname()
{
    ...
    if(!isNaN(namevalue))
    {
        document.getElementById("lnameerror").innerHTML="lname can not be numeric";
        return false;
    }
    else if(isNaN(namevalue) && namevalue.length<4)
    {
...
function agecheck()
{
    ...
    else if(!isNaN(agevalue) && agevalue.length<1)
    {
        document.getElementById("ageerror").innerHTML="Age can't be less than 2 numbers";
        return false;
    }
    else
    {
...
{
    var emailpattern = /^\w+([\.-]?\w+)*@[A-Za-z\d]+\.aiub.edu+$/;

   //var e=/^aiub.edu+&/;
   //var emailpattern = /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+\.aiub.edu$/;
    //var emailpattern2 = /.@student.aiub/;
...
function formcheck()
{
    if(checkname()==true && checklname()==true && agecheck()==true && getradiovalue()==true && checkboxvalue()==true&& validateemail()==true && passcheck()==true)
    {
        return true;
    }
    else
